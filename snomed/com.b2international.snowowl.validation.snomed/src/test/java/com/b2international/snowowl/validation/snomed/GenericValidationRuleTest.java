...
public class GenericValidationRuleTest extends BaseGenericValidationRuleTest {
	...
	public void rule38a() throws Exception {
		...
		assertThat(issues.stream().map(ValidationIssue::getAffectedComponent).collect(Collectors.toSet()))
			...
			.doesNotContainAnyElementsOf(List.of(ComponentIdentifier.of(SnomedTerminologyComponentConstants.CONCEPT_NUMBER, activeConceptWithInferredParent.getId()),
	...
	public void rule38b() throws Exception {
		...
		assertThat(issues.stream().map(ValidationIssue::getAffectedComponent).collect(Collectors.toSet()))
			...
			.doesNotContainAnyElementsOf(List.of(ComponentIdentifier.of(SnomedTerminologyComponentConstants.CONCEPT_NUMBER, activeConceptWithStatedParent.getId()),
	...
	public void rule45c() throws Exception {
		...
		assertThat(issues.stream().map(ValidationIssue::getAffectedComponent).collect(Collectors.toSet()))
			...
			.doesNotContainAnyElementsOf(List.of(ComponentIdentifier.of(RELATIONSHIP_NUMBER, definingRelationshipInGroup0.getId()),
	...
	public void rule80() throws Exception {
		...
		assertThat(issues.stream().map(ValidationIssue::getAffectedComponent).collect(Collectors.toSet()))
			...
			.doesNotContainAnyElementsOf(List.of(ComponentIdentifier.of(CONCEPT_NUMBER, validConcept1.getId()),
  ...
  @Test
	...
	private void rule532(String ruleId, String descriptionType, String moduleId) throws Exception {
		...
		assertAffectedComponents(issues,
			...
			ComponentIdentifier.of(SnomedTerminologyComponentConstants.DESCRIPTION_NUMBER, invalidDescriptionOnActiveConceptWithActiveInactivityIndicator.getId())
		);
	}
	...
	public void rule_mrcm_constraint() throws Exception {
		...
		indexRevision(MAIN, relationship1, relationship2, relationship3, axiomMember1, axiomMember2, axiomMember3, axiomMember4, axiomMember5);
