 ...
 * @since 10.0
 */
public class GeneralImportConfiguration {
	private final String id;
	private final RemoteJobState status;
	private final ApiError error;
	private final ImportResponse response;
	
	public GeneralImportConfiguration(final String id, final RemoteJobState status, final ApiError error, final ImportResponse response) {
		this.id = id;
		this.status = status;
		this.error = error;
