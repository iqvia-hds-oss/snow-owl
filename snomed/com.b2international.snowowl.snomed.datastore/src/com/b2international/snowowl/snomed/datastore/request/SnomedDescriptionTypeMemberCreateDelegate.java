 ...
 * @since 5.0
 */
final class SnomedDescriptionTypeMemberCreateDelegate extends SnomedRefSetMemberCreateDelegate {

	SnomedDescriptionTypeMemberCreateDelegate(SnomedRefSetMemberCreateRequest request) {
		super(request);
	}
	...
	protected Set<String> getRequiredComponentIds() {
		checkNonEmptyProperty(SnomedRf2Headers.FIELD_DESCRIPTION_FORMAT);
		return ImmutableSet.of(getComponentId(SnomedRf2Headers.FIELD_DESCRIPTION_FORMAT));
	}
}
