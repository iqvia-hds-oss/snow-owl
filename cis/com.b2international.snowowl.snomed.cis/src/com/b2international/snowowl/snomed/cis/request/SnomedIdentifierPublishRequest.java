 ...
 * @since 5.5
 */
final class SnomedIdentifierPublishRequest extends AbstractSnomedIdentifierEnumeratedRequest {

	SnomedIdentifierPublishRequest(final Set<String> componentIds) {
		super(componentIds);
	}
	
	@Override
	public SctIds execute(ServiceProvider context) {
		return new SctIds(context.service(ISnomedIdentifierService.class).publish(componentIds()).values());
	}
