 ...
 * @since 10.2.0
 */
public final class FhirCodeSystemSetIncludeInCapabilitiesRequestBuilder
	extends BaseRequestBuilder<FhirCodeSystemSetIncludeInCapabilitiesRequestBuilder, TransactionContext, Boolean>
	implements ResourceRepositoryTransactionRequestBuilder<Boolean> {

	private List<String> codeSystemIds;
	private boolean includeInCapabilities;
	...
	protected Request<TransactionContext, Boolean> doBuild() {
		return new FhirCodeSystemSetIncludeInCapabilitiesRequest(codeSystemIds, includeInCapabilities);
	}
}
