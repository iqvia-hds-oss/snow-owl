 ...
 * @since 5.0
 */
final class SnomedSimpleMemberUpdateDelegate extends SnomedRefSetMemberUpdateDelegate {

	SnomedSimpleMemberUpdateDelegate(SnomedRefSetMemberUpdateRequest request) {
		super(request);
	}
