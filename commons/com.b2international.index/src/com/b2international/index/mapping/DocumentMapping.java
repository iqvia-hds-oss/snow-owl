...
public final class DocumentMapping {
	...
	private final Doc.RefreshPolicy refreshPolicy;
	...
	public DocumentMapping(Class<?> type, DocumentMapping parent, boolean nested) {
		...
		// store the refresh policy of the document
		this.refreshPolicy = doc != null ? doc.refreshPolicy() : Doc.RefreshPolicy.STANDARD;
	...
	public Doc.RefreshPolicy getRefreshPolicy() {
