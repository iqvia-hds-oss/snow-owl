...
public class FhirValueSetController extends AbstractFhirResourceController {
	...
	@ApiResponse(responseCode = "201", description = "Value set created or updated", content = @Content(schema = @Schema(implementation = OperationOutcomeSchema.class)))
	...
	@ApiResponse(responseCode = "200", description = "Value set updated", content = @Content(schema = @Schema(implementation = OperationOutcomeSchema.class)))
	@ApiResponse(responseCode = "201", description = "Value set created", content = @Content(schema = @Schema(implementation = OperationOutcomeSchema.class)))
	@ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = OperationOutcomeSchema.class)))
