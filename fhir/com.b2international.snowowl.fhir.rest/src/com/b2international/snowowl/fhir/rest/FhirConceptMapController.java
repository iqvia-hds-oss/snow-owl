...
public class FhirConceptMapController extends AbstractFhirResourceController {
	 ...
	 * If the concept map already exists then a new revision is created instead.
	 * 
	...
	@ApiResponse(responseCode = "201", description = "Concept map created or updated", content = @Content(schema = @Schema(implementation = OperationOutcomeSchema.class)))
