 ...
 * @since 6.11
 */
public interface IReasonerTaxonomy {

	IReasonerTaxonomy EMPTY = new IReasonerTaxonomy() {
		@Override
		...
		public IInternalSctIdMultimap getEquivalentConcepts() {
			return IInternalSctIdMultimap.EMPTY;
		}
	}; 
	
	IInternalSctIdSet getUnsatisfiableConcepts();

	IInternalSctIdMultimap getEquivalentConcepts();
}
