...
final class SnomedQueryEvaluationRequest implements Request<BranchContext, Promise<Expression>>, BranchAccessControl {
	...
	protected Promise<Expression> eval(BranchContext context, final TermFilter termFilter) {
		...
		case MATCH:
			expression = SnomedDescriptionIndexEntry.Expressions.termDisjunctionQuery(com.b2international.snowowl.core.request.TermFilter.defaultTermMatch(termFilter.getTerm()));
			break;
		case REGEX:
