...
/*package*/ class CompleteUploadRequest implements Request<ServiceProvider, Boolean> {
	...
	/*package*/ CompleteUploadRequest(final UUID attachmentId, final HashCode expectedHashCode) {
	...
	public Boolean execute(final ServiceProvider context) {
		...
		service.completeUpload(attachmentId, expectedHashCode);
		return Boolean.TRUE;
	}
}
