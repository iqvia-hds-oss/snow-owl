...
IF DEFINED JAVA_HOME (
	...
	for /D %%D in ("%KERNEL_HOME%\plugins\org.eclipse.justj.openjdk.hotspot.jre.*") do (
...
REM Run Snow Owl
PUSHD %KERNEL_HOME%
"%JAVA_EXECUTABLE%" %SO_JAVA_OPTS% -jar plugins\org.eclipse.equinox.launcher_1.7.100.v20251111-0406.jar
POPD
