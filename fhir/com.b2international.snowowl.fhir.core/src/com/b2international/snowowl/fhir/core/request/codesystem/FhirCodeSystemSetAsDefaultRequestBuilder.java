 ...
 * @since 10.2.0
 */
public final class FhirCodeSystemSetAsDefaultRequestBuilder
	...
	FhirCodeSystemSetAsDefaultRequestBuilder(final String codeSystemId) {
		this.codeSystemId = codeSystemId;
	}

	@Override
	protected Request<TransactionContext, Boolean> doBuild() {
		return new FhirCodeSystemSetAsDefaultRequest(codeSystemId);
	}
}
