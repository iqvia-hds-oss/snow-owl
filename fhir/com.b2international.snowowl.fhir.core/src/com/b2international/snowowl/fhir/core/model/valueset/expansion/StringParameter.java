...
public class StringParameter extends Parameter<String> {
	...
	public static class Builder extends Parameter.Builder<Builder, StringParameter, String> {
		...
		@Override
		protected StringParameter doBuild() {
