 ...
 * @since 6.0
 */
public enum ValidationIssueRequests {

	INSTANCE;
	
	public ValidationIssueGetRequestBuilder prepareGet(String issueId) {
		return new ValidationIssueGetRequestBuilder(issueId);
	}
	
	public ValidationIssueSearchRequestBuilder prepareSearch() {
