...
/**
 * FHIR Datetime typed property, designated as propertyName[x] in the specification.
 * 
 * @see <a href=" https://www.hl7.org/fhir/formats.html">Choice</a> for further information about how to use [x].
 * @since 7.1
 */
public class InstantProperty extends TypedProperty<Instant> {
	
	public InstantProperty(Instant value) {
		super(value);
	}
}
