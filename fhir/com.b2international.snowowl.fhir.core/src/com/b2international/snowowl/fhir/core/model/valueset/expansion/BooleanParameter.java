...
public class BooleanParameter extends Parameter<Boolean> {
	...
	public static class Builder extends Parameter.Builder<Builder, BooleanParameter, Boolean> {
		...
		@Override
		protected BooleanParameter doBuild() {
